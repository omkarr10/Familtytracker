...
export default function Geofences() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Geofences</h1>
        <button
          onClick={() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          {geofences.length === 0 ? (
            <div className="card p-8 text-center">
              <Shield className="w-12 h-12 text-gray-300 dark:text-dark-600 mx-auto mb-3" />
              <p className="text-gray-500 dark:text-dark-400">No geofences created</p>
            ...
            geofences.map((geofence) => (
              <div key={geofence.id} className="card p-4">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 dark:text-white">{geofence.name}</h3>
        ...
        {/* Map */}
        <div className="lg:col-span-2 h-[500px] card overflow-hidden p-0">
          <MapContainer
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="card w-full max-w-md p-6">
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-4">Add New Geofence</h2>
              ...
              <>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    />
                    <div className="text-center text-sm text-gray-600 dark:text-dark-400">
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-gray-700 dark:text-dark-300">Alert on enter</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-primary-600 rounded"
                      />
                      <span className="text-sm text-gray-700 dark:text-dark-300">Alert on exit</span>
                    </label>
                  </div>
                </div>
              </>
